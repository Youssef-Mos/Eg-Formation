...
export function DatePickerPermis({ onDateChange }: { onDateChange: (date: Date | undefined) => void }) {
    ...
    <div className="flex flex-col space-y-2 cursor-pointer ">
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
        <PopoverTrigger asChild>
          ...
          >
            {selectedDate ? format(selectedDate, "PPP") : <span> Délivrance du permis</span>}
