...
<>
    <div className="flex flex-col gap-4 w-full border-b-2 border-zinc-500 pb-5">
        <h1 className='text-4xl font-bold text-center'>Bienvenue sur <span className='bg-gradient-to-r from-indigo-600 via-blue-300 to-red-600 animate-gradient-mid bg-clip-text text-transparent '>Eg-Formations</span></h1>
