      ...
      <div className={`p-3 rounded-lg border transition-all duration-200 ${hasChanged ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`}>
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div>
            ...
            <p className="text-gray-800 bg-white p-2 rounded border">{String(original)}</p>
          </div>
          <div>
            <p className="text-gray-500 mb-1">Après</p>
            <p className={`p-2 rounded border font-medium ${hasChanged ? 'text-blue-800 bg-blue-100 border-blue-200' : 'text-gray-800 bg-white'}`}>
              {String(current)}
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white relative overflow-hidden">
              ...
              <button 
                className="absolute top-4 right-4 text-white/80 hover:text-white hover:bg-white/10 rounded-full p-2 transition-all duration-200 z-20 cursor-pointer" 
                onClick={handleClose}
              >
                <X size={20} />
              </button>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold">Modifier le stage</h1>
                    <p className="text-blue-100">#{stage.NumeroStage} - {stage.Titre}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <Tabs value={showPreview ? "preview" : activeTab} onValueChange={setActiveTab} className="w-full">
                <div className="border-b border-gray-200 px-6 py-4">
                  <TabsList className="grid w-full grid-cols-4 gap-2">
                    <TabsTrigger value="info" className="cursor-pointer">Informations</TabsTrigger>
                    <TabsTrigger value="location" className="cursor-pointer">Localisation</TabsTrigger>
                    <TabsTrigger value="schedule" className="cursor-pointer">Planning</TabsTrigger>
                    <TabsTrigger value="preview" className="cursor-pointer" disabled={!hasChanges()}>
                      Aperçu {hasChanges() && <div className="w-2 h-2 bg-blue-500 rounded-full ml-1"></div>}
                    </TabsTrigger>
                  </TabsList>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          disabled
                          className="h-12 bg-gray-100 text-gray-500"
                        />
                  ...
                  <TabsContent value="preview" className="space-y-6">
                    {hasChanges() ? (
                      <>
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                          <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-semibold text-blue-800">Aperçu des modifications</h3>
                          </div>
                      ...
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">Aucune modification détectée</p>
                        <p className="text-gray-400 text-sm">Modifiez les informations dans les onglets précédents</p>
                      </div>
                    )}
                  </TabsContent>
                </div>
