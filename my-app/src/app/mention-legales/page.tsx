...
<p>L'entreprise EG-FORMATIONS est éditeur du site ADRESSE DU SITE A DEFINIR (<a href="https://eg-formations.net" className="text-blue-600 hover:underline">Eg-formations.net</a>) sur lequel elle propose au Conducteur l'inscription à un stage de sensibilisation à la Sécurité Routière objet des présentes conditions générales.</p>
...
<p>L'inscription par les Conducteurs aux stages de sensibilisation à la Sécurité Routière se fait directement sur le site ADRESSE DU SITE A DEFINIR (<a href="https://eg-formations.net" className="text-blue-600 hover:underline">Eg-formations.net</a>).</p>
