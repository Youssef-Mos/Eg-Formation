...
>
  ...
  <span className="hidden sm:block">Conditions Générales</span>
</TabsTrigger>
...
>
  ...
  <span className="hidden xs:block sm:hidden">Règlement</span>
  <span className="hidden sm:block">Règlement Intérieur</span>
</TabsTrigger>
...
>
  ...
  <span className="hidden sm:block">Informations Légales</span>
</TabsTrigger>
...
<TabsTrigger value="confidentialite" className="flex flex-col xs:flex-row items-center justify-center gap-1 xs:gap-2 py-2 px-1 xs:px-2 text-xs xs:text-sm">
    ...
    <span className="hidden sm:block">Confidentialité</span>
  </TabsTrigger>
</TabsList>
...
<p>L'entreprise EG-FORMATIONS est éditeur du site <a href="https://eg-formations.net" className="text-blue-600 hover:underline">Eg-formations.net</a> sur lequel elle propose au Conducteur l'inscription à un stage de sensibilisation à la Sécurité Routière objet des présentes conditions générales.</p>
...
<p>L'inscription par les Conducteurs aux stages de sensibilisation à la Sécurité Routière se fait directement sur le site <a href="https://eg-formations.net" className="text-blue-600 hover:underline">Eg-formations.net</a>.</p>
...
<th className="border border-gray-300 p-2 text-left">Données collectées</th>
...
<tbody>
<tr>
<td className="border border-gray-300 p-2">Nom, prénom, date de naissance</td>
...
<tr className="bg-gray-50">
<td className="border border-gray-300 p-2">Adresse, téléphone, email</td>
...
<td className="border border-gray-300 p-2">3 ans après fin de relation</td>
</tr>
<tr>
<td className="border border-gray-300 p-2">N° permis de conduire</td>
<td className="border border-gray-300 p-2">Transmission à la Préfecture</td>
<td className="border border-gray-300 p-2">Obligation légale</td>
<td className="border border-gray-300 p-2">10 ans</td>
</tr>
<tr className="bg-gray-50">
<td className="border border-gray-300 p-2">Données de paiement</td>
<td className="border border-gray-300 p-2">Facturation et comptabilité</td>
<td className="border border-gray-300 p-2">Obligation légale</td>
<td className="border border-gray-300 p-2">10 ans</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td className="border border-gray-300 p-2">Adresse IP, données de navigation</td>
<td className="border border-gray-300 p-2">Sécurité et fonctionnement du site</td>
...
<td className="border border-gray-300 p-2">Statistiques de fréquentation</td>
...
<h3 className="text-lg font-bold mt-4">3. Destinataires des données</h3>

<h4 className="font-semibold mt-3">3.1 Destinataires obligatoires</h4>
<ul className="list-disc pl-6 mt-2 space-y-1">
<li><strong>Préfecture compétente</strong> : Transmission obligatoire des attestations de stage</li>
<li><strong>ANTS (Agence Nationale des Titres Sécurisés)</strong> : Récupération des points</li>
...
<ul className="list-disc pl-6 mt-2 space-y-1">
<li><strong>Google (Analytics)</strong> : États-Unis - Décision d'adéquation Commission Européenne</li>
<li><strong>Stripe</strong> : Irlanda (UE) et États-Unis - Clauses contractuelles types</li>
</ul>
...
<h4 className="font-semibold mt-3">5.1 Droit d'accès (Article 15)</h4>
<p>Vous pouvez demander l'accès à vos données personnelles et obtenir une copie.</p>
...
<h4 className="font-semibold mt-3">5.3 Droit à l'effacement (Article 17)</h4>
<p>Vous pouvez demander la suppression de vos données, sauf obligations légales de conservation.</p>

<h4 className="font-semibold mt-3">5.4 Droit à la limitation (Article 18)</h4>
<p>Vous pouvez demander la limitation du traitement dans certains cas.</p>

<h4 className="font-semibold mt-3">5.5 Droit à la portabilité (Article 20)</h4>
...
<h4 className="font-semibold mb-2 mt-3">📋 Informations à fournir</h4>
<ul className="list-disc pl-6 space-y-1">
<li>Nom, prénom</li>
<li>Adresse email utilisée sur notre site</li>
<li>Nature de la demande</li>
<li>Copie d'une pièce d'identité</li>
</ul>
</div>

<p className="mt-3"><strong>Délai de réponse :</strong> Nous nous engageons à répondre dans un délai de 1 mois maximum.</p>

<h3 className="text-lg font-bold mt-4">7. Sécurité des données</h3>
...
<h3 className="text-lg font-bold mt-4">8. Violation de données</h3>
...
<h3 className="text-lg font-bold mt-4">9. Droit de réclamation</h3>
...
<p className="break-words">Cette politique de confidentialité peut être modifiée. Toute modification sera publiée sur cette page avec indication de la date de mise à jour. Les modifications importantes vous seront notifiées par email.</p>
...
<p><strong>Dernière mise à jour :</strong> 22 mai 2025</p>
